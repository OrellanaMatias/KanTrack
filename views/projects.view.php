...
<div class="row d-flex m-0 p-0 mt-4">
    ...
    <div class="col-3 p-0 pl-3 pr-1">
        <div class="card-hover-shadow-2x mb-3 card text-dark">
            ...
            <h4 class="card-header-title font-weight-normal"><i class="fa fa-suitcase mr-3"></i>PROYECTOS DE <?php echo strtoupper($_SESSION['user']);?></h4>
                                                ...
                                                <form name="id_project_task" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="GET" role="form">
                                                    ...
                                                    <button class="btn" type="submit">
                                                        <div class="widget-content-left">
                                                            ...
                                                            <div class="widget-subheading text-muted"><i>Inicio: <?php echo $p['start_date'];?></i></div>
                                                            <div class="widget-subheading text-muted"><i>Fin: <?php echo $p['end_date'];?></i></div>                                                       
    ...
    <div class="col-9 p-0 pr-3 pl-1">
        <div class="card-hover-shadow-2x mb-3 card text-dark">
            <div class="card-header-tab card-header d-flex justify-content-between">
                <h4 class="card-header-title font-weight-normal"><i class="fas fa-clipboard-list pr-3"></i>TAREAS</h4>
                <?php if (isset($show_tasks)) { 
                    echo"<button type='button' class='btn btn-primary' data-toggle='modal' data-target='#new-task-modal'>Nueva tarea</button>";
                        ...
                        <div class="ps-content">
                            <div class="row m-2 mt-4">
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-list mr-3"></i>POR HACER</h5>                                            
                                        </div>
                                ...
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header d-flex justify-content-between">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-cogs mr-3"></i>EN PROGRESO</h5>                                            
                                        </div>
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
                                ...
                                <div class="col-4">
                                    <div class="card-hover-shadow-2x mb-3 card text-dark">
                                        <div class="card-header-tab card-header d-flex justify-content-between">
                                            <h5 class="card-header-title font-weight-normal"><i class="fas fa-check mr-3"></i>COMPLETADO</h5>                                            
                                        </div>
                                        <div class="scroll-area-sm">
                                            <perfect-scrollbar class="ps-show-limits">
                                                <div style="position: static;" class="ps ps--active-y">
