	...
	<nav class="navbar navbar-expand-lg pt-3 text-dark">
		<div class="menu container">
            ...
            <ul class="navbar-nav ml-auto">
                <li><span class="btn text-primary mx-2"><i class="far fa-user pr-2"></i>Bienvenido <?php echo strtoupper($_SESSION['user']);?>!</li>
    ...
    <div class="row d-flex m-2 mt-0">
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="today.php">
               ...
               <div class="card-body d-flex justify-content-center">
                    <h3 class="card-title"></i>PARA HOY</h3>
               </div>
            </a>                   
        </div>
        ...
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="projects.php">
               ...
               <div class="card-body d-flex justify-content-center">
                    <h3 class="card-title"></i>PROYECTOS</h3>
               </div>
            </a>                   
        </div>
        ...
        <div class="col-sm-4 col-md-4">
            <a class="card my-card text-dark" href="calendar.php">
               ...
               <div class="card-body d-flex justify-content-center">
                    <h3 class="card-title"></i>CALENDARIO</h3>
               </div>
            </a>                   
        </div>        
    </div>
