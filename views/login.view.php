		...
		<div class="menu container">
			...
			<div id="navbarSupportedContent" class="collapse navbar-collapse">
				<ul class="navbar-nav ml-auto">
					<li><a href="register.php" class="btn btn-primary text-light mr-2"></i>Registrarse</a></li>				
				</ul>
			</div>
		</div>
	</nav>
...
<div class="container">
	<div class="row m-0 p-0">	
		<div class="col-6 p-5 justify-content-center">
			<p class="text-center h1 fw-bold m-5">Iniciar sesión</p>
			...
			<span class="d-flex justify-content-center">No tienes una cuenta?<a class="nav-link text-primary m-0 p-0 pl-2" href="register.php">Registrarse</a></span>			
		</div>
		<div class="col-6 p-3">
