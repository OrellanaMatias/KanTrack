...
<div class="container">
	<div class="row m-0 p-0">
		...
		<div class="col-6 p-5 justify-content-center">
			<p class="text-center h1 fw-bold m-5">REGISTRARSE</p>
			<form class="px-5" name="signup" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
				...
				<button type="submit" class="btn btn-primary" onclick="signup.submit()">Registrarse</button>
				</div>
			...
			<span class="d-flex justify-content-center">Ya tienes una cuenta?<a class="nav-link text-primary m-0 p-0 pl-2" href="login.php">Iniciar sesión</a></span>			
		</div>
